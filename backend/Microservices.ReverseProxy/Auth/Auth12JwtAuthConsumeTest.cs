...
public static class Auth12JwtAuthConsumeTest
{
    ...
    public static void AddJwtAuthenticationTestConsumerAuth(this WebApplicationBuilder builder)
    {
    ...
    public static void AddJwtAuthenticationTest(this WebApplication app)
    {
